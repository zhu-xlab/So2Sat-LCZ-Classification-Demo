#!/usr/bin/env python
# -*- coding: utf-8 -*-
# File              : readROI2xyMinMax.py
# Author            : Jingliang
# Date              : 09.07.2018 10:10:44
# Last Modified Date: 09.07.2018 10:10:44
# Last Modified By  : Yuanyuan Wang <y.wang@tum.de>

# Last modified: 09.07.2018 10:11:00 Yuanyuan Wang
# changed ROI path as an input, instead of hard coded
...
#2nd row: upper-left cornor, 3rd row: bottom-right cornor
utmPoints, utmProjInfo = roiLatlon2UTM(wgsPoints)
print(utmPoints[1,0], utmPoints[2,1], utmPoints[2,0], utmPoints[1,1])
